...
| devVersion, releaseVersion | `versionFromTag`                                 | generates a version name from name of currently checked-out tag, or the most recent tag on your branch. If the name starts with something like `v1.2.3` the `1.2.3` will be pulled out and used | 
